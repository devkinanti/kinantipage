  ...
  <div>
    ...
    >
      <v-list>
        <v-list-item>
          <v-list-item-avatar>
            <img src="@/assets/img/DITJENPAS.png" alt="Logo" />
          </v-list-item-avatar>
          <v-list-item-content>
            <v-list-item-title class="title">ONLINE</v-list-item-title>
    ...
    >
      <v-toolbar-title>
        <v-img src="@/assets/img/logowhitefont.png" max-width="500" />
      </v-toolbar-title>
      <v-spacer />
      <v-app-bar-nav-icon
      ...
      <div v-else>
        ...
        <v-btn text @click="$vuetify.goTo('#kursus')">
          <span class="mr-2">KURSUS</span>
        </v-btn>
        <v-btn text @click="$vuetify.goTo('#berita')">
          <span class="mr-2">BERITA</span>
        </v-btn>
